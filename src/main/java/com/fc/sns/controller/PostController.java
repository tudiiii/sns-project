...
import com.fc.sns.controller.response.PostCommentResponse;
...
public class PostController {
    ...
    public Response<Page<PostCommentResponse>> comment(@PathVariable Integer postId, Pageable pageable) {
